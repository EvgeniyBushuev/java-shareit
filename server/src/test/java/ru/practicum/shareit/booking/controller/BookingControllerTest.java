...
public class BookingControllerTest {
    ...
    void getAllByStateTest() throws Exception {
        ...
        verify(bookingService, times(1)).getAllByState(eq(RequestBookingState.ALL), eq(userId), anyInt(), anyInt());
        verifyNoMoreInteractions(bookingService);
    }
    ...
    void getAllByStateForOwnerTest() throws Exception {
        ...
        verify(bookingService, times(1)).getAllByStateForOwner(eq(RequestBookingState.ALL), eq(userId), anyInt(), anyInt());
        verifyNoMoreInteractions(bookingService);
    }
