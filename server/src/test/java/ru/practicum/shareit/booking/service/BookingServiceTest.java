...
public class BookingServiceTest {
    ...
    void getAllByStateTest() {
        ...
        responseDtoList = bookingService.getAllByState(RequestBookingState.ALL, booker.getId(), 0, 10);
        bookingService.getAllByState(RequestBookingState.PAST, booker.getId(), 0, 10);
        bookingService.getAllByState(RequestBookingState.FUTURE, booker.getId(), 0, 10);
        bookingService.getAllByState(RequestBookingState.CURRENT, booker.getId(), 0, 10);
        bookingService.getAllByState(RequestBookingState.WAITING, booker.getId(), 0, 10);
        bookingService.getAllByState(RequestBookingState.REJECTED, booker.getId(), 0, 10);
    ...
    void getAllByStateForOwnerTest() {
        ...
        responseDtoList = bookingService.getAllByStateForOwner(RequestBookingState.ALL, owner.getId(), 0, 10);
        bookingService.getAllByStateForOwner(RequestBookingState.PAST, owner.getId(), 0, 10);
        bookingService.getAllByStateForOwner(RequestBookingState.FUTURE, owner.getId(), 0, 10);
        bookingService.getAllByStateForOwner(RequestBookingState.CURRENT, owner.getId(), 0, 10);
        bookingService.getAllByStateForOwner(RequestBookingState.WAITING, owner.getId(), 0, 10);
        bookingService.getAllByStateForOwner(RequestBookingState.REJECTED, owner.getId(), 0, 10);
